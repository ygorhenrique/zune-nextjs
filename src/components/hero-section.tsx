  ...
  return (
    <section className="hero-bg bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <form action="https://app.zune.money/signup" method="get" className="flex flex-col md:flex-row justify-center mb-6">
        ...
        <Link href="https://app.zune.money/demo" className="text-white underline hover:text-yellow-400">
          Try our demo
        </Link>
        <div className="mt-8">
          <Image
