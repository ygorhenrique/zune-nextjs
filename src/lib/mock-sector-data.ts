...
const sectorData: Record<string, SectorData> = {
  tech: {
    ...
    topStocks: [
      { ticker: "AAPL", name: "Apple Inc.", price: 189.84, dividendYield: 0.5, peRatio: 31.2, marketCap: 2950 },
      {
        ticker: "MSFT",
      ...
      { ticker: "TSLA", name: "Tesla, Inc.", price: 177.58, dividendYield: 0, peRatio: 50.8, marketCap: 565 },
      { ticker: "ADBE", name: "Adobe Inc.", price: 474.75, dividendYield: 0, peRatio: 45.6, marketCap: 215 },
      {
        ticker: "CRM",
        name: "Salesforce, Inc.",
        price: 273.66,
  ...
  energy: {
    ...
    topStocks: [
      ...
      { ticker: "SHEL", name: "Shell plc", price: 71.82, dividendYield: 3.8, peRatio: 12.9, marketCap: 235 },
      { ticker: "BP", name: "BP p.l.c.", price: 35.42, dividendYield: 4.5, peRatio: 11.2, marketCap: 98 },
      {
        ticker: "TTE",
  ...
  finance: {
    ...
    topStocks: [
      ...
      { ticker: "C", name: "Citigroup Inc.", price: 61.78, dividendYield: 3.1, peRatio: 10.2, marketCap: 118 },
      {
        ticker: "GS",
      ...
      { ticker: "MS", name: "Morgan Stanley", price: 97.42, dividendYield: 3.4, peRatio: 16.8, marketCap: 159 },
      {
        ticker: "BLK",
        name: "BlackRock, Inc.",
        price: 806.77,
      ...
      { ticker: "V", name: "Visa Inc.", price: 277.18, dividendYield: 0.8, peRatio: 31.2, marketCap: 560 },
    ],
    trends: [
      {
  ...
  healthcare: {
    ...
    topStocks: [
      ...
      { ticker: "PFE", name: "Pfizer Inc.", price: 28.15, dividendYield: 5.7, peRatio: 15.6, marketCap: 159 },
      { ticker: "ABBV", name: "AbbVie Inc.", price: 170.87, dividendYield: 3.5, peRatio: 50.8, marketCap: 302 },
      {
        ticker: "MRK",
        name: "Merck & Co., Inc.",
        price: 125.45,
      ...
      { ticker: "AMGN", name: "Amgen Inc.", price: 268.08, dividendYield: 3.3, peRatio: 21.5, marketCap: 143 },
    ],
    trends: [
      {
  ...
  consumer: {
    ...
    topStocks: [
      ...
      { ticker: "PEP", name: "PepsiCo, Inc.", price: 169.84, dividendYield: 3.1, peRatio: 25.7, marketCap: 233 },
      {
        ticker: "COST",
      ...
      { ticker: "WMT", name: "Walmart Inc.", price: 60.24, dividendYield: 1.4, peRatio: 28.5, marketCap: 485 },
      {
        ticker: "HD",
      ...
      { ticker: "NKE", name: "NIKE, Inc.", price: 93.46, dividendYield: 1.5, peRatio: 27.8, marketCap: 141 },
      {
        ticker: "MCD",
...
export function getPopularStocks(): { ticker: string; name: string }[] {
  return [
